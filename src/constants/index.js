...
export const EXPERIENCES = [
  ...
  {
    year: "2024",
    role: "Teaching Assistant (University Lab)",
    company: "University Lab",
    description: `Assisted in teaching Data Structures and Algorithms (DSA) to university students. Helped students with practical coding exercises, guiding them to implement algorithms in languages like C++ and Python. Provided support in debugging and understanding complex problem-solving concepts.`,
...
export const PROJECTS = [
  ...
  {
    title: "Quiz Game",
    image: "https://picsum.photos/400/300?random=11", // Random Image 11
    description:
...
export const CONTACT = {
  address: "Moh. Qutab Abad Sargodha Road Gujrat ",
  phoneNo: "+92 3368763487 ",
  email: "alihassan26032004@gmail.com",
};
